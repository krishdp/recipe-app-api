...
class PublicUserApiTests(TestCase):
    ...
    def test_crate_token_with_invalid_token(self):
        """Test that token will not create if invalid credentials are provided"""
    ...
    def test_create_token_no_user(self):
        """Test that token will not created if the user is not found"""
        payload = {'email': 'test@londonappdev.com', 'password': 'testpass'}
        res = self.client.post(TOKEN_URL, payload)
